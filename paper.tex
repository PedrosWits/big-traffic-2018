...
\begin{abstract} \small\baselineskip=9pt Increases in price and performance of automatic number plate recognition over the last two decades has led to  by law enforcement and urban traffic control. In this work we show how \end{abstract}
